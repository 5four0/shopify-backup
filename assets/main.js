...
class StoreHeader extends HTMLElement {
   ...
   */
  show() {
     // document.querySelector(".cc-header--sticky").classList.remove('is_sticky');
    this.classList.remove('is-out');
    // this.classList.remove('is_sticky');
  ...
  hide() {
    if (!this.stickyTransitioning) {
      ...
      // this.classList.add('is_sticky');
      // document.querySelector(".cc-header--sticky").classList.add('is_sticky');
      this.stickyTransitioning = true;
      setTimeout(() => {
        this.lastScrollPos = document.documentElement.scrollTop;
        this.stickyTransitioning = false;
